    ...
    <div className="app-layout">
      ...
      <main className="main-content">
        <div className="page-header">
          ...
          <p>
            {isEditing
              ? `Editing ${form.symbol || "trade"}`
              : "Record every detail of your trade for maximum insights"}
          </p>
        </div>
        <div className="page-body">
          <form onSubmit={handleSubmit}>
            {livePnl !== null && (
              <div
                ...
                style={{
                  marginBottom: "24px",
                  background:
                    livePnl >= 0 ? "var(--profit-bg)" : "var(--loss-bg)",
                  border: `1px solid ${livePnl >= 0 ? "rgba(0,230,118,0.2)" : "rgba(255,82,82,0.2)"}`,
                  textAlign: "center",
                  padding: "20px",
                }}
              >
                ...
                <div
                  ...
                  style={{
                    fontSize: "2rem",
                    fontWeight: 800,
                    color: livePnl >= 0 ? "var(--profit)" : "var(--loss)",
                  }}
                >
                ...
                <div className="form-group">
                  ...
                  <div className="flex gap-8">
                    <button
                      type="button"
                      style={{ flex: 1 }}
                      className={`btn ${form.direction === "long" ? "btn-primary" : "btn-secondary"}`}
                    ...
                    <button
                      type="button"
                      style={{ flex: 1 }}
                      className={`btn ${form.direction === "short" ? "btn-primary" : "btn-secondary"}`}
            ...
            <div className="card mb-24">
              <div className="card-header">
                <span className="card-title">🎯 Strategy &amp; Setup</span>
              </div>
              <div className="form-row">
                <div className="form-group">
                ...
                <div className="form-group">
                  ...
                  <input
                    className="form-input"
                    placeholder="e.g. VWAP Bounce, Gap &amp; Go"
                    value={form.strategy}
                ...
                <div className="form-group">
                  ...
                  <input
                    className="form-input"
                    placeholder="e.g. earnings, high-volume, catalyst"
                    value={form.tags}
            ...
            <div className="card mb-24">
                  ...
                  <div className="emotion-grid">
                    {EMOTIONS.map((e) => (
                      <button
                        type="button"
                        key={e.value}
                        className={`emotion-btn ${form.emotionBefore === e.value ? "selected" : ""}`}
                        onClick={() => handleChange("emotionBefore", e.value)}
                      >
                        {e.emoji} {e.label}
                      </button>
                    ))}
                    ...
                    <div className="emotion-grid">
                      {EMOTIONS.map((e) => (
                        <button
                          type="button"
                          key={e.value}
                          className={`emotion-btn ${form.emotionAfter === e.value ? "selected" : ""}`}
                          onClick={() => handleChange("emotionAfter", e.value)}
                        >
                          {e.emoji} {e.label}
                        </button>
                      ))}
              ...
              <div className="form-group mt-16">
                ...
                <input
                  ...
                  onChange={(e) =>
                    handleChange("confidence", parseInt(e.target.value))
                  }
                />
                <div
                    ...
                    <button 
                      ...
                      onClick={() => {
                        ...
                        if (isLocked) {
                          ...
                          (document.getElementById('scroll-lock-btn') as HTMLElement).classList.add('btn-ghost');
                        } else {
                          document.body.classList.add('scroll-locked');
                          (document.getElementById('scroll-lock-btn') as HTMLElement).innerHTML = '🔒 Stop Drawing & Unlock';
                          (document.getElementById('scroll-lock-btn') as HTMLElement).classList.add('btn-primary');
                          (document.getElementById('scroll-lock-btn') as HTMLElement).classList.remove('btn-ghost');
                        }
                      }}
                      id="scroll-lock-btn"
            ...
            <div className="card mb-24">
              ...
              <div className="form-group">
                <textarea
                  ...
                  placeholder="What was your thesis? What did you observe? Any lessons learned?"
                  value={form.notes}
