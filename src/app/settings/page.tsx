...
export default function SettingsPage() {
  ...
  useEffect(() => {
    setMounted(true);
    if (user) {
      Promise.all([getTrades(user.uid), getJournalEntries(user.uid)]).then(
        ([trades, journals]) => {
  ...
  const clearAllData = async () => {
    ...
    if (
      confirm(
        "⚠️ This will permanently delete ALL your trades and journal entries. Are you sure?",
      )
    ) {
      ...
      <main className="main-content">
        ...
        <div className="page-body" style={{ maxWidth: "700px" }}>
          ...
          <div className="card mb-24">
            ...
            >
              Export your data as JSON for backup, or import data from a
              previous export.
            </p>
          ...
          <div className="card mb-24">
            ...
            <div style={{ fontSize: "0.9rem", lineHeight: 1.8 }}>
              <p>
                <strong>Monstah Trading Journal</strong> v1.0.0
              </p>
              <p className="text-muted">
                A free, AI-powered trading journal built to help you track
                trades, analyze performance, and improve your trading through
          ...
          >
            <div className="card-header">
              <span className="card-title" style={{ color: "var(--loss)" }}>
                ⚠️ Danger Zone
              </span>
            </div>
            <p
              ...
              style={{ fontSize: "0.85rem", marginBottom: "16px" }}
            >
              Permanently delete all your trades and journal entries. This
